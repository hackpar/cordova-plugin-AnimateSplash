...
public class SplashScreen extends CordovaPlugin {
    ...
    private LottieAnimationView viewsss;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (newConfig.orientation != orientation) {
            ...
            if (viewsss != null) {
                int drawableId = preferences.getInteger("SplashDrawableId", 0);
                if (drawableId != 0) {
                    viewsss.setImageDrawable(cordova.getActivity().getResources().getDrawable(drawableId));
                }
            }
        }
    }
            ...
            public void run() {
                if (splashDialog != null && splashDialog.isShowing()) {
                    ...
                    if (fadeSplashScreenDuration > 0 && forceHideImmediately == false) {
                        ...
                        viewsss.setAnimation(fadeOut);
                        viewsss.startAnimation(fadeOut);
    ...
    private void showSplashScreen(final boolean hideAfterDelay) {
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                viewsss = new LottieAnimationView(context);
                LayoutParams layoutParams = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
                viewsss.setLayoutParams(layoutParams);

                viewsss.setMinimumHeight(display.getHeight());
                viewsss.setMinimumWidth(display.getWidth());


                viewsss.setImageAssetsFolder("www/bootstarp/images/");
                viewsss.setAnimation("www/bootstarp/data.json");
                viewsss.loop(false);

                viewsss.playAnimation();
                ...
                splashDialog.getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new OnSystemUiVisibilityChangeListener() {
                    @Override
